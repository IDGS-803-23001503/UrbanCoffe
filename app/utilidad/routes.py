...
@utilidad.route('/utilidad')
def index():
    """Panel principal de costos y utilidad"""
    return redirect(url_for('utilidad.dashboard'))


@utilidad.route('/utilidad/dashboard')
def dashboard():
    """Dashboard con resumen de costos y utilidad"""
    try:
        ...
        # Calcular costo de ventas del día
    ...
    return render_template('utilidad/index.html',
...
@utilidad.route('/utilidad/reporte', methods=['GET', 'POST'])
def reporte():
    ...
    if request.method == 'POST' and form.validate():
        ...
        for venta in ventas_query:
            ...
            for detalle in venta.detalles:
                ...
                if producto:
                    ...
                    # Acumular para resumen de productos
        ...
        # Convertir productos_detalle a lista ordenada por utilidad
        lista_productos = []
...
@utilidad.route('/utilidad/producto/<int:producto_id>')
def producto_detalle(producto_id):
    """Detalle de rentabilidad de un producto específico"""
...
@utilidad.route('/utilidad/reporte/pdf', methods=['POST'])
def reporte_pdf():
